...
void swapFirstAndLast(node*& H) {
    ...
    if (size(H) < 2) {
        cout << "Lista posiada tylko jeden element- niemo¿liwa zamiana" << endl;
        return;
    }
...
int main() {
    ...
    //    cout << endl;
    //    spacer("Operacja kopiowania elementu za je¿eli jest parzysty");
    ...
    //    cout << endl;
    //    spacer("Operacja przeniesienia najwiekszego elementu na pocz¹tek listy");
